                ...
                <form id="customer">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="customer_name" value="<?=$data['customer']['name']?>" placeholder="Müşteri adını giriniz.">
                        </div>
                        <div class="form-group">
                            <label for="customer_surname">Müşteri Soyadı</label>
                            <input type="text" class="form-control" id="customer_surname" value="<?=$data['customer']['surname']?>" placeholder="Müşteri soyadını giriniz.">
                        </div>
                        <div class="form-group">
                            <label for="customer_company">Müşteri Şirket Adı</label>
                            <input type="text" class="form-control" id="customer_company" value="<?=$data['customer']['company']?>" placeholder="Müşteri şirketini giriniz.">
                        </div>
                        <div class="form-group">
                            <label for="customer_phone">Müşteri Telefon</label>
                            <input type="text" class="form-control" id="customer_phone" value="<?=$data['customer']['phone']?>" placeholder="Müşteri telefonunu giriniz.">
                        </div>
                        <div class="form-group">
                            <label for="customer_gsm">Müşteri GSM</label>
                            <input type="text" class="form-control" id="customer_gsm" value="<?=$data['customer']['gsm']?>" placeholder="Müşteri gsmini giriniz.">
                        </div>
                        <div class="form-group">
                            <label for="customer_email">Müşteri E-Mail</label>
                            <input type="text" class="form-control" id="customer_email" value="<?=$data['customer']['email']?>" placeholder="Müşteri emailini giriniz.">
                        </div>
                        <div class="form-group">
                            <label for="customer_adress">Müşteri Adres</label>
                            <textarea class="form-control" id="customer_adress"  placeholder="Müşteri adresini giriniz."><?=$data['customer']['adress']?></textarea>
                        </div>
                    </div>
                    <!-- /.card-body -->
